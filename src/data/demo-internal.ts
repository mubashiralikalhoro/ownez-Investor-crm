...
import { ACTIVE_PIPELINE_STAGES, COMMITTED_STAGES, TOUCH_ACTIVITY_TYPES, LEAD_SOURCES, PIPELINE_STAGES } from "@/lib/constants";
import { computeDaysSinceLastTouch, computeIsStale, computeIsOverdue } from "@/lib/stale";
import { getTodayCT } from "@/lib/format";

let users: User[] = [
  { id: "u-chad", username: "chad", fullName: "Chad Cormier", role: "rep", isActive: true, passwordHash: "" },
  { id: "u-ken", username: "ken", fullName: "Ken Warsaw", role: "marketing", isActive: true, passwordHash: "" },
  { id: "u-eric", username: "eric", fullName: "Eric Gewirtzman", role: "admin", isActive: true, passwordHash: "" },
  { id: "u-efri", username: "efri", fullName: "Efri Argaman", role: "admin", isActive: true, passwordHash: "" },
];
...
let people: Person[] = [
  // === 12 PROSPECTS ===
  {
    ...
    nextActionType: "Document", nextActionDetail: "Send Q3 performance deck", nextActionDate: "2026-03-17",
  ...
  },
  {
    ...
    nextActionType: "Other", nextActionDetail: "Confirm entity for investment", nextActionDate: "2026-02-27",
  ...
  },
  {
    ...
    nextActionType: "Meeting", nextActionDetail: "Discovery meeting — 2:00 PM today", nextActionDate: "2026-02-25",
  ...
  },
  {
    ...
    nextActionType: "Follow-up", nextActionDetail: "Follow up on pitch — no response yet", nextActionDate: "2026-02-24",
  ...
  },
  {
    ...
    nextActionType: "Other", nextActionDetail: "Invite to investor dinner March 5", nextActionDate: "2026-03-01",
  ...
  },
  {
    ...
    nextActionType: "Follow-up", nextActionDetail: "Check with attorney on LLC docs", nextActionDate: "2026-02-28",
    leadSource: "velocis_network", assignedRepId: "u-chad", collaboratorIds: [],
  ...
  },
  {
    ...
    nextActionType: "Follow-up", nextActionDetail: "Follow up on passport upload in Agora", nextActionDate: "2026-02-26",
    leadSource: "cpa_referral", assignedRepId: "u-chad", collaboratorIds: [],
  ...
  },
  {
    ...
    initialInvestmentTarget: null, growthTarget: null, committedAmount: null, commitmentDate: null,
    nextActionType: "Follow-up", nextActionDetail: "Schedule intro call", nextActionDate: "2026-02-26",
  ...
  },
  {
    ...
    nextActionType: "Follow-up", nextActionDetail: "Re-engage after tax season", nextActionDate: "2026-04-15",
    leadSource: "legacy_event", assignedRepId: "u-chad", collaboratorIds: [],
  ...
  },
  {
    ...
    nextActionType: "Document", nextActionDetail: "Send case study — similar investor profile", nextActionDate: "2026-02-28",
  ...
  // === 3 FUNDED INVESTORS ===
  {
    ...
    nextActionType: "Follow-up", nextActionDetail: "Quarterly check-in", nextActionDate: "2026-03-15",
    leadSource: "velocis_network", assignedRepId: "u-chad", collaboratorIds: [],
  ...
  },
  {
    ...
    nextActionType: "Follow-up", nextActionDetail: "Target $500K total", nextActionDate: "2026-03-01",
    leadSource: "cpa_referral", assignedRepId: "u-chad", collaboratorIds: [],
  ...
  },
  {
    ...
    nextActionType: "Follow-up", nextActionDetail: "Wants to double after Q4 returns", nextActionDate: "2026-03-10",
    leadSource: "linkedin", assignedRepId: "u-chad", collaboratorIds: [],
...
export function createMockDataService(): DataService {
  return {
    ...
    async createPerson(data: Partial<Person>): Promise<Person> {
      const roles = data.roles ?? ["prospect"];
      const isProspect = roles.includes("prospect");
      let pipelineStage: PipelineStage | null;
      if (data.pipelineStage !== undefined) {
        pipelineStage = data.pipelineStage;
      } else {
        pipelineStage = isProspect ? "prospect" : null;
      }
      const newPerson: Person = {
        ...
        roles,
        pipelineStage,
        stageChangedDate: isProspect ? getTodayCT() : null,
    ...
    async getDashboardStats(): Promise<DashboardStats> {
      ...
      const fundedYTD = fundedInvestments
        .filter((fi) => fi.investmentDate >= yearStart)
